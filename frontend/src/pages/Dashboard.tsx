    ...
    >
      <div className="mb-8">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full mb-3
          ...
          <BarChart3 size={12} className="text-[#A855F7]" />
          <span className="text-xs font-semibold text-[#C084FC] uppercase tracking-widest">Live Metrics</span>
        </div>
        ...
        <p className="text-[#9B8EC4] mt-2">Real-time fraud detection metrics and insights.</p>
      </div>
